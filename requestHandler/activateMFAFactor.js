...
const activateMFAFactor = async (req, res) => {
  ...
  if (req?.body) {
    const responseObj = {
        'response': {testOperation: "/sign-up/activate-factor called sccessfully..........."},
    };
    try {
        ...
        logger
          .logCreator()
          .trace("Error at activateMFAFactor");
        res.json(null);
      }
}
};

module.exports = { activateMFAFactor };
