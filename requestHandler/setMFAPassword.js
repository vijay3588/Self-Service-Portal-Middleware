...
const setMFAPassword = async (req, res) => {
  ...
  if (req?.body) {
    const responseObj = {
        'response': {testOperation: "/sign-up/set-password called sccessfully..........."},
    };
    try {
        ...
        logger
          .logCreator()
          .trace("Error at setMFAPassword");
        res.json(null);
      }
}
};

module.exports = { setMFAPassword };
